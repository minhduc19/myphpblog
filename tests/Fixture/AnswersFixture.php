...
class AnswersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'article_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-03-24 15:52:00',
                'modified' => '2021-03-24 15:52:00',
                'article_id' => 1,
                'user_id' => 1,
            ],
        ];
